          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1.5">
                {companyIds.length > 1
                  ? 'เลือกทั้ง 2 บริษัท: อีเมลจะแสดงชื่อผู้ส่งเป็น "CONNEX" แทนชื่อบริษัทเดี่ยว (ยังส่งแยก 2 ฉบับให้พนักงานแต่ละบริษัทตามปกติ ท้ายอีเมลแต่ละฉบับยังเป็นที่อยู่/เลขผู้เสียภาษีของบริษัทที่ส่งจริง)'
                  : 'เลือกบริษัทเดียว: อีเมลออกในนามบริษัทนั้นตามปกติ — เลือกทั้ง 2 บริษัทจะเปลี่ยนชื่อผู้ส่งเป็น "CONNEX" แทน'}
              </p>
            </div>
          </div>
